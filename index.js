...
// Add functions for the other actions
...
function addDepartment() {
    inquirer.default.prompt([
        ...
        .then((answer) => {
            db.query('INSERT INTO department (name) VALUES ($1)', [answer.departmentName], (err, res) => {
                if (err) throw err;
...
function addRole() {
    db.query('SELECT * FROM department', (err, res) => {
        ...
        inquirer.default.prompt([
            ...
            .then((answers) => {
                db.query('INSERT INTO role (title, salary, department_id) VALUES ($1, $2, $3)', [answers.roleTitle, answers.roleSalary, answers.departmentId], (err, res) => {
                    if (err) throw err;
    ...
    db.query('SELECT * FROM employee', (err, res) => {
        ...
        db.query('SELECT * FROM role', (err, res) => {
            ...
            inquirer.default.prompt([
                ...
                .then((answers) => {
                    db.query('UPDATE employee SET role_id = $1 WHERE id = $2', [answers.roleId, answers.employeeId], (err, res) => {
                        if (err) throw err;
